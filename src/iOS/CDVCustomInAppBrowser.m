/*
 ...
 # 原始檔案：https://github.com/apache/cordova-plugin-inappbrowser/tree/master/src/ios
 # 異動說明：此檔案原本為Cordova CDVInAppBrowser修改後的類別，目的是為了擷取WebView中的JS事件
 # 建議使用diffNow線上程式比對軟體進行比較 http://www.diffnow.com/
 */

#import "CDVCustomInAppBrowser.h"
...
@interface CDVCustomInAppBrowser () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVCustomInAppBrowser

- (CDVCustomInAppBrowser*)initWithWebView:(UIWebView*)theWebView
{
...
{
    CDVCustomInAppBrowserOptions* browserOptions = [CDVCustomInAppBrowserOptions parseOptions:options];
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVCustomInAppBrowserViewController alloc] initWithUserAgent:originalUA prevUserAgent:[self.commandDelegate userAgent] browserOptions: browserOptions];
...
- (BOOL)webView:(UIWebView*)theWebView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    } // 接收前端的協定(window.location="CustomInAppBrowser:")
    else if([[url scheme] isEqualToString:@"custominappbrowser"]){
        UIImage *image = [WebViewUtil takeScreenshotFromWebview:theWebView];
...
@implementation CDVCustomInAppBrowserViewController

@synthesize currentURL;

- (id)initWithUserAgent:(NSString*)userAgent prevUserAgent:(NSString*)prevUserAgent browserOptions: (CDVCustomInAppBrowserOptions*) browserOptions
{
    self = [super init];
    if (self != nil) {
...
@implementation CDVCustomInAppBrowserOptions
...
+ (CDVCustomInAppBrowserOptions*)parseOptions:(NSString*)options
{
    CDVCustomInAppBrowserOptions* obj = [[CDVCustomInAppBrowserOptions alloc] init];
